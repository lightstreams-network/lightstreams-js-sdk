...
var fetchTxReceipt = function fetchTxReceipt(web3, txHash, expiredAt) {
  return new Promise(function (resolve, reject) {
    web3.eth.getTransactionReceipt(txHash, function _callee(err, receipt) {
      var _receipt;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 9:
              _context.prev = 9;
              _context.next = 12;
              return regeneratorRuntime.awrap(fetchTxReceipt(web3, txHash, expiredAt));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return regeneratorRuntime.awrap(fetchGasPrice(web3));
          ...
          case 6:
            ...
            _context2.next = 10;
            return regeneratorRuntime.awrap(calculateEstimateGas(web3, {
              data: contractData
            }));
...
module.exports.contractSendTx = function (web3, _ref8) {
  var contractAddr = _ref8.to,
      from = _ref8.from,
      abi = _ref8.abi,
      method = _ref8.method,
      params = _ref8.params,
