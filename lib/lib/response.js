...
module.exports.parseResponse = function (gwResponse) {
  if (gwResponse.statusCode !== 200) {
    if (_typeof(gwResponse.body) === 'object' && _typeof(gwResponse.body.error) === 'object') {
  ...
  var _gwResponse$body = gwResponse.body,
      error = _gwResponse$body.error,
      response = _objectWithoutProperties(_gwResponse$body, ["error"]);
